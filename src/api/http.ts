...
// The live backend sends Wix's formatted total ("$127.95", "$1,027.95");
// older answers and the tests send a plain number. Read both.
function toCents(total: unknown): number {
